...
<div style="color:#000; font-weight:500; background-color:#fff; padding:10px;">
<p class="bigtitle">Report submitted to CBAT: (4337) ARECIBO</p>
<pre>
...
[% INCLUDE "$TPL/imgn.tpl" file = "$IMG/publications/chords-mono-DG-PN.png" w = "70%" %]
...
[% INCLUDE "$TPL/imgn.tpl" file = "$IMG/publications/chords-mono-RN-KB.png" w = "70%" %]
...
profile, the diameters determined from the second occultation are:
   ...
   Main body  24.3 &plusmn; 0.6 km
   Satellite  13.0 &plusmn; 1.5 km
...
main body, for both occultations. Those positions are:
   ...
   2021 May 19.74861 25.5 &plusmn;1.0 mas in PA 105.2&deg; &plusmn;1.0&deg;
   2021 June 9.45736 32.8 &plusmn;0.7 mas in PA  94.3&deg; &plusmn;2.7&deg;
